...
const KPITooltip: React.FC<{ content: string }> = ({ content }) => {
  ...
  return (
    <div className="relative">
      <div
        className="w-4 h-4 bg-gray-500 hover:bg-gray-600 rounded-full flex items-center justify-center cursor-help transition-colors"
      ...
      {isVisible && (
        <div className="absolute top-4 right-0 w-64 bg-gray-900 text-white text-sm rounded-lg p-3 shadow-lg z-50">
