...
const AdvancedROI: React.FC<AdvancedROIProps> = ({ selectedClient }) => {
  ...
  const calculateSimpleROI = () => {
    const cost = parseFloat(simpleCost) || 0;
    ...
    setSimpleResults({
      ...
      profit,
      roiPercentage,
      explanation: `ROI calculated: $${revenue.toLocaleString()} revenue - $${cost.toLocaleString()} cost = $${profit.toLocaleString()} profit (${roiPercentage.toFixed(1)}% ROI)`
    });
  ...
  const calculateCampaignROI = async () => {
    if (!selectedCampaign || !salesDataFile || !campaignCost) {
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center text-sm">
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">${simpleResults.cost.toLocaleString()}</p>
                    </div>
                    <div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="font-semibold text-gray-900 mb-2">Required Data Fields:</h4>
              ...
              <button
                ...
                disabled={!selectedCampaign || !salesDataFile || !campaignCost || isCalculating}
